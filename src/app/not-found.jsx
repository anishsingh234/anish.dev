  ...
  return (
    <main className="relative min-h-screen bg-[#0a0a0f] flex flex-col items-center justify-center overflow-hidden cursor-none">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(104,51,135,0.18) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="relative z-10 text-center max-w-xl px-6">
        ...
        <h1
          className="text-[130px] font-black leading-none tracking-tighter text-transparent select-none"
        ...
        <div
          className="w-14 h-0.5 mx-auto my-4 rounded"
          style={{
            background:
              "linear-gradient(90deg, transparent, #683387, transparent)",
          }}
        />
        ...
        <p className="text-2xl font-bold text-[#f0e8f5] mb-3">
