...
import BlobCursor from "@/components/_animations/BlobCursor";
import BubbleSkills from "@/components/_animations/BubbleSkills";
import SkillFlow from "@/components/_animations/FlipUp";
        ...
        >
          <div
            ...
            style={{
              width: `${progress}%`,
              background:
                "linear-gradient(90deg, rgba(251,191,36,0.3), #fbbf24)",
            }}
          />
        </div>
...
/* ── Dynamic Earth3D ──────────────────────────────────────────────────────── */
const Earth3D = dynamic(() => import("@/components/_animations/Earth3D"), {
  ssr: false,
...
const ANIMATIONS = [
  ...
  },
  {
    ...
    label: "Bubbles",
    index: "03",
    sub: "Floating skill particles",
    accentColor: "#38bdf8",
    Component: BubbleSkills,
  },
  {
    id: "skillflow",
    label: "Skill Flow",
    index: "04",
    sub: "Logic flip sequence",
    accentColor: "#6366f1",
    Component: SkillFlow,
  },
];
...
const TICKER =
  "ANIMATION STUDIO ◆ INTERACTIVE CANVAS ◆ LIVE PREVIEW ◆ NEXT.JS ◆ REACT ◆ FRAMER MOTION ◆ TAILWIND CSS ◆ ";
...
export default function AnimationStudio() {
  ...
  const prevAnim =
    ANIMATIONS[(activeIdx - 1 + ANIMATIONS.length) % ANIMATIONS.length];
  const nextAnim = ANIMATIONS[(activeIdx + 1) % ANIMATIONS.length];
  const { Component } = current;

  const goPrev = () =>
    setActiveIdx((i) => (i - 1 + ANIMATIONS.length) % ANIMATIONS.length);
    ...
    */
    ...
    >
      ...
      <div
        ...
        style={{
          background: `radial-gradient(circle, ${current.accentColor}10 0%, transparent 70%)`,
        }}
      />
      ...
      >
        <div className="flex items-center w-full">
          ...
          <Link
            href="/"
            className="flex items-center gap-3 px-5 py-3 border-r flex-shrink-0 group transition-all duration-200 hover:bg-white/[0.03]"
          ...
          >
            <svg
              ...
              className="text-white/40 group-hover:text-white transition-colors duration-200 flex-shrink-0"
            >
                ...
                >
                  <span
                    style={{
                      fontSize: 9,
                      letterSpacing: "0.2em",
                      color: isActive ? a.accentColor : "#666",
          ...
          {/* Live dot */}
          <div
            className="flex items-center gap-2 px-5 py-3 flex-shrink-0 border-l"
            style={{ borderColor: "#1a1a1a" }}
          >
            <span
              ...
              style={{
                ...
                boxShadow: `0 0 6px ${current.accentColor}`,
              }}
            />
            <span
      ...
      <main className="relative z-10 flex-1 overflow-hidden pb-[88px] sm:pb-0">
        <div
          ...
          style={{
            animation: "studioFadeIn 0.4s cubic-bezier(0.4,0,0.2,1) both",
          }}
        >
          <Component />
        </div>
        ...
        <div className="absolute bottom-[96px] sm:bottom-9 left-3 pointer-events-none">
          <div className="w-px h-3 bg-[#222]" />
          <div className="w-3 h-px bg-[#222]" />
        </div>
        <div className="absolute bottom-[96px] sm:bottom-9 right-3 pointer-events-none flex flex-col items-end">
          <div className="w-px h-3 bg-[#222]" />
          <div className="w-3 h-px bg-[#222]" />
        </div>
        ...
        <div className="absolute bottom-[88px] sm:bottom-3 left-4 pointer-events-none select-none">
          <span
            ...
            style={{ color: current.accentColor, opacity: 0.04 }}
          >
            {current.index}
          </span>
        </div>
              ...
              {ANIMATIONS.map((a, idx) => (
                <button
                  ...
                  style={{
                    ...
                    boxShadow:
                      activeIdx === idx ? `0 0 6px ${a.accentColor}80` : "none",
                  }}
                />
              ))}
            </div>
