...
const TextLoop = ({
  ...
  letterSpacing = 2,
  uppercase = true,
  color = 'url(#text-loop-gradient)',
  ribbon = false,
  ribbonColor = 'rgb(124 58 237 / 0.12)',
  ribbonWidth = 2,
  pauseOnHover = true,
  className = '',
  style = {}
  ...
  const resolvedColor = color === 'url(#text-loop-gradient)' ? `url(#${gradientId})` : color;
  ...
  return (
    <div ref={rootRef} className={`relative w-full overflow-hidden ${className}`.trim()} style={style}>
      ...
      >
        ...
        <text className="select-none" style={textStyle} fill={resolvedColor} dominantBaseline="central" aria-hidden="true">
